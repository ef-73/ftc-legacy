...
public class E_odom_pos_calc extends LinearOpMode {
    ...
    double encoder_ppr= 8192; //8192CPR or 8192 PPR for REV through bore encoder on REV website
    double wheel_radius_M = 0.0175;// 0.036M for radius of goBilda omniwheel || 0.0175M for radius of "openodometry" omniwheel
    ...
    public void runOpMode() {
        ...
        odom_toPoint runToPoint = new odom_toPoint(1, 1, 180, 0.6, 2.7, 3.5, 0.03, 0.067, 0.4);
        odom_toPoint backToPoint = new odom_toPoint(0, 0, 0, 0.6, 2.7, 3.5, 0.03, 0.067, 0.4);
        ...
        while (opModeIsActive()) {
            ...
            double lfPower = Vrx - Vry - Vrotate;//local vel to global frame vel
            double rfPower = Vrx + Vry + Vrotate;
            double lrPower = Vrx + Vry - Vrotate;
            double rrPower = Vrx - Vry + Vrotate;
    ...
    private void odom_pos_est(){
        ...
        while (!isStopRequested() && opModeIsActive()){
            ...
            encoder_r = encoderToMetres(rf.getCurrentPosition()); //negative if using gobilda omniwheel bot, positive if using openodometry bot
